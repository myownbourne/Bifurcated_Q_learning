...
num_sim = 200
CJ22_set = c(0,0.05,0.1,0.15,0.2,0.5,0.8,1.1,1.4,1.7,2.0,2.3,2.5)
CJ23_set = 2*CJ22_set
num_J = length(CJ22_set)
Learners = c("SL.glmnet","SL.ranger","SL.glm","SL.caret.rpart")
#Learners = c("SL.glmnet","SL.ranger","SL.glm")
...
sim_result = foreach(j = 1:num_sim, .combine = 'c') %dopar% {
  ...
  n = 500; d1 = 25; d2 = 25; d = 1+d1+d2;
  
  beta_A1 = 0.5^(1:d1);
  beta_A2 = 0.5^(1:d);
  beta_y1 = rep(0.2,d1); beta_y2 = rep(0.2,d); 
  beta_y1A = rep(0.4,d1); beta_y1A[1:4] = c(1,1,1,1)
  beta_y2A = rep(0.4,d); beta_y2A[(d-3):d] = c(1,1,1,1)
  ...
  L1 = seq(from = 1, to = 12, by = 1)
  J11 = seq(from = 13, to = d1, by = 1)
  J1s = list(J11)
  
  J21 = seq(from = 4, to = 8, by = 1)
  J22 = seq(from = 4, to = 13, by = 1)
  J23 = seq(from = 4, to = d2, by = 1)
  J2s = list(J21,J22,J23)
  L2 = seq(from = 1, to = 3, by = 1)
  C1s = c(0,0)
  C2s = c(0,0)
  CJ22_set = c(0,0.05,0.1,0.15,0.2,0.5,0.8,1.1,1.4,1.7,2.0,2.3,2.5)
  CJ23_set = 2*CJ22_set
  
  JJ11 = seq(from = 13, to = d1, by = 1)
  JJ1 = list(JJ11)
  JJ21 = seq(from = 4, to = 8, by = 1)
  JJ22 = seq(from = 9, to = 13, by = 1)
  JJ23 = seq(from = 14, to = d2, by = 1)
...
write.csv(long_format_data, file = "result_S18.csv", row.names = FALSE)
