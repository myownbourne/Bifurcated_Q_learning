...
BQL_regimes_4 <- function(alphas,betas,gammas,deltas,S1_new,J1s,J2s,L1,L2,C1s,CJ1s,C2s,CJ2s,parms,rho)
{
  n_test = nrow(S1_new)
  ...
  S2_new = get_S2(S1_new,a1_hat,rho)
...
HDQ_glasso_regimes = function(psi1,psi2,S1_new,J1s,J2s,L1,L2,C1s,C2s,parms,rho)
{
  ...
  S2_new = get_S2(S1_new,a1_hat_,rho)
...
RQL_gLasso_regimes <- function(alpha_hat,beta_hat,S1_new,J1s,J2s,L1,L2,C1s,C2s,parms,rho)
{
  n_test = nrow(S1_new); d1 = ncol(S1_new); 
  X1_new = cbind(1,S1_new)
  a1_hat = as.vector(ifelse((X1_new%*%beta_hat) > (C1s[2]-C1s[1]), 1, 0)); 
  S2_new = get_S2(S1_new,a1_hat,rho); d2 = ncol(S2_new);
...
RQLo_regimes <- function(alpha_hat,beta_hat,S1_new,C1s,C2s,parms,rho)
{
  n_test = nrow(S1_new)
...
HDQo_regimes = function(psi1,psi2,S1_new,J1s,J2s,L1,L2,C1s,C2s,parms,rho)
{
  n_test = nrow(S1_new); d1 = ncol(S1_new);
