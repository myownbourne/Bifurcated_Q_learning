...
#for(j in 1:num_sim){
  ...
  sim_resulti = matrix(0, nrow = num_a2, ncol = 5)
...
stopCluster(cl)
sim_result <- array(unlist(sim_result), dim = c(num_a2, 5, num_sim))
...
write.csv(long_format_data, file = "result_S15_time.csv", row.names = FALSE)
